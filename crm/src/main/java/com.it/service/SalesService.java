...
public class SalesService {
    ...
    public void saveSales(Sales sales) {
        ...
        sales.setRealname(ShiroUtil.getCurrentRealName());
        ...
        salesLog.setLogsalesid(sales.getId());
    ...
    public void saveLog(SalesLog salesLog) {
        ...
        //修改机会的最后跟进时间
        Sales sales = salesMapper.findById(salesLog.getLogsalesid());
    ...
    public void delSales(Integer id) {
        ...
        if (sales != null) {
            ...
            if (!salesFileList.isEmpty()) {
                salesFileMapper.delSalesFile(salesFileList);
            }
            //删除对应跟进记录
            List<SalesLog> salesLogList = salesLogMapper.findBySalesId(id);
            if (!salesLogList.isEmpty()) {
                salesLogMapper.delSalesLog(salesLogList);
            }
